...
esquisse_ui <- function(id,
  ...
  tag_header <- tags$div(
    ...
    tags$div(
      ...
      actionButton(
        inputId = ns("settings_pre"),
        label = ph("gear-six", height = "2em", title = mgi18n("设置")),
        class = "btn-sm",
        title = mgi18n("设置")
      ),
      # actionButton(
      ...
      actionButton(
        inputId = ns("settings"),
        label = ph("gear_six", height = "2em", title = mgi18n("映射")),
        class = "btn-sm",
        title = mgi18n("映射")
      ),
      actionButton(
        inputId = ns("close"),
        label = ph("x", height = "2em", title = mgi18n("Close Window")),
        class = "btn-sm",
        title = mgi18n("Close Window")
      )
    ),
    tags$div(
      class = "pull-left",
      actionButton(
        ...
        label = ph("database", height = "2em", title = mgi18n("Import data")),
        class = "btn-sm",
        title = mgi18n("Import data")
      ),
      actionButton(
        inputId = ns("show_data"),
        label = ph("table", height = "2em", title = mgi18n("Show data")),
        class = "btn-sm",
        title = mgi18n("Show data")
      )
    )
  )
