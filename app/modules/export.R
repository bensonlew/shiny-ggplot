  ...
  tagList(
    ...
    tags$div(
      ...
      textInputIcon(
        ...
        label = NULL,
        value = "export-plot",
        placeholder = mgi18n("Filename"),
        icon = list(mgi18n("Filename:")),
        width = "100%"
      ),
      numericInputIcon(
        inputId = ns("width"),
      ...
      numericInputIcon(
        ...
        label = NULL,
        value = 400,
        icon = list(mgi18n("Height:")),
        width = "100%"
      ),
      actionButton(
        inputId = ns("update_preview"),
        label = tagList(ph("eye"), mgi18n("Update Preview")),
        style = "margin-bottom: 15px;"
      )
    ),
    tags$div(
      tags$label(mgi18n("Export format:")),
      tags$div(
        style = css(
          display = "grid",
...
downloads_labels <- function(label = ph("download-simple"),
                             ...
                             more = tagList(ph("gear"), mgi18n("More options"))) {
  list(
    label = label,
    png = png,
    pdf = pdf,
          ...
          if (requireNamespace(package = "rvg") & requireNamespace(package = "officer")) {
            ...
            if ("try-error" %in% class(ppt)) {
              shiny::showNotification(
                ui = mgi18n("Export to PowerPoint failed..."),
                type = "error",
